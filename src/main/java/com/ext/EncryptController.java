...
public class EncryptController{
	...
	@GetMapping("/test1")
	 public void dotest() {
		...
		/**/
	...
	public String userinfo(@RequestHeader Map<String, String> header,@RequestBody HashMap<String,String> body) {
		...
		//version 검증
		if(encVersion.equals(encVersion)) {
		...
		System.out.println("decrypt 결과: " +res);
